...
import    { getPostComent as Query_getPostComent } from './resolvers/Query/getPostComent';
...
import    { User } from './resolvers/User';
    export const resolvers: Resolvers = {
      Query: { getAllComments: Query_getAllComments,getAllPosts: Query_getAllPosts,getAllUsers: Query_getAllUsers,getCurrentUser: Query_getCurrentUser,getPostComent: Query_getPostComent,getPostDetails: Query_getPostDetails,healthCheck: Query_healthCheck,hello: Query_hello },
