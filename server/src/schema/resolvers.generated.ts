...
import    { User } from './resolvers/User';
    export const resolvers: Resolvers = {
      Query: { getAllPosts: Query_getAllPosts,getAllUsers: Query_getAllUsers,getCurrentUser: Query_getCurrentUser,getPostDetails: Query_getPostDetails,healthCheck: Query_healthCheck,hello: Query_hello },
